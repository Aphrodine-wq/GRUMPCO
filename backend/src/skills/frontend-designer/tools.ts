  ...
  input_schema: {
    ...
    properties: {
      ...
      filePath: {
        type: "string",
        description:
          "Path to a .svelte file to review (alternative to providing code directly)",
      },
    },
  },
};
  ...
  input_schema: {
    ...
    properties: {
      ...
      filePath: {
        type: "string",
        description:
          "Path to a .svelte file to enhance (alternative to providing code directly)",
      },
      focusAreas: {
        type: "array",
        items: {
        ...
        description:
          "Specific areas to focus the enhancement on (default: all)",
      },
    },
  },
};
