  ...
  input_schema: {
    ...
    properties: {
      ...
      language: {
        type: "string",
        description:
          "Programming language of the code (e.g., typescript, python, go)",
      },
      reviewType: {
        type: "string",
      ...
      context: {
        type: "string",
        description:
          "Additional context about the code (e.g., what it does, known issues)",
      },
    },
    required: ["code"],
  },
...
export const suggestImprovementsTool: ToolDefinition = {
  ...
  description:
    "Generate specific improvement suggestions for code with before/after examples",
  input_schema: {
    type: "object",
    properties: {
      code: {
