  ...
  tools: [
    {
      ...
      description:
        'Generate a comprehensive README.md for a project based on its structure and code',
      input_schema: {
        type: 'object',
        properties: {
    ...
    },
    {
      name: 'add_jsdoc',
      description:
        'Add JSDoc/TSDoc comments to functions, classes, and interfaces in TypeScript/JavaScript code',
      input_schema: {
        type: 'object',
        properties: {
          ...
          style: {
            ...
            description: 'Documentation verbosity',
          },
        },
        required: ['code'],
      },
  ...
  async execute(toolName: string, input: Record<string, unknown>): Promise<string> {
    switch (toolName) {
      ...
      case 'generate_api_docs': {
        const { code, format, baseUrl } = input as {
          code: string;
          format?: string;
          baseUrl?: string;
        };
