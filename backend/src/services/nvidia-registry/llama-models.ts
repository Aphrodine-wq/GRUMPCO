...
export const LLAMA_MODELS: NvidiaModelConfig[] = [
  ...
  },
  {
    ...
    description:
      "Flagship Llama model with 405B parameters for maximum performance",
    bestFor: [
      "complex reasoning",
      "advanced coding",
      "research",
  ...
  },
  {
    ...
    description:
      "Multi-modal safety model for content classification and moderation",
    bestFor: [
      "content moderation",
      "safety filtering",
  ...
  },
  {
    ...
    description:
      "Leading reasoning and agentic AI model for PC and edge deployment",
  ...
  // CodeLlama Models
  {
    ...
    costPerTokenOutput: 0.02 / 1_000_000,
    description:
      "Lightweight code generation model for fast inference and edge deployment",
    bestFor: [
      "code completion",
      "code explanation",
      "lightweight coding",
  ...
  },
  {
    ...
    description:
      "Balanced code generation model with improved accuracy over 7B",
  ...
  },
  {
    ...
    description:
      "High-performance code model with strong reasoning for complex programming tasks",
    bestFor: [
  ...
  },
  {
    ...
    costPerTokenOutput: 0.35 / 1_000_000,
    description:
      "Flagship CodeLlama model with 100K context for large codebase understanding",
    bestFor: [
