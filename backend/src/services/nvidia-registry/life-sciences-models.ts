...
export const LIFE_SCIENCES_MODELS: NvidiaModelConfig[] = [
  ...
  },
  {
    ...
    costPerTokenOutput: 0,
    description:
      "Third-generation biomolecular foundation model for structure prediction",
  ...
  },
  {
    ...
    costPerTokenOutput: 0,
    description:
      "Deep learning for predicting amino acid sequences for protein backbones",
  ...
  },
  {
    ...
    costPerTokenOutput: 0,
    description:
      "Generates multiple sequence alignment from query sequence and database",
    bestFor: [
      "sequence alignment",
