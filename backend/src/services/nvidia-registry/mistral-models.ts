...
export const MISTRAL_MODELS: NvidiaModelConfig[] = [
  ...
  },
  {
    ...
    description:
      "Powerful, multimodal language model designed for enterprise applications",
  ...
  },
  {
    ...
    description:
      "Latency-optimized language model excelling in code, math, general knowledge",
  ...
  },
  {
    ...
    description:
      "General purpose VLM ideal for chat and instruction-based use cases",
  ...
  },
  {
    ...
    description:
      "State-of-the-art open code model with deep reasoning and 256k context",
  ...
  },
  {
    ...
    description:
      "Efficient MoE LLM that follows instructions and completes requests",
