...
import { generateArchitecture } from '../ship/architectureService.js';
import { generatePRD } from '../ship/prdGeneratorService.js';
import {
  optimizeEnrichedIntent,
  parseAndEnrichIntent,
  type EnrichedIntent,
} from '../intent/intentCompilerService.js';
import { getCachedContext, cacheContext } from '../caching/contextCache.js';
...
export async function generateMasterContext(
  ...
  try {
    ...
    const optimizationOpportunities =
      contextData.optimizationOpportunities ||
