...
- Supported providers: NVIDIA NIM, OpenRouter
*/`;
...
**Ready for real AI?**
Just add an API key from NVIDIA NIM or OpenRouter to your \\\`backend/.env\\\` file and restart!`,

      `🤖 **G-Rump Mock Mode Active**
