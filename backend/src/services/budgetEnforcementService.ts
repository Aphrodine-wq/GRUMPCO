...
export function checkBudgetLimits(
  ...
  const result: BudgetCheckResult = {
    ...
    currentCost: {
      request: {
        cents: tracker.requestCostCents,
        dollars: tracker.requestCostCents / 100,
      },
      session: {
        cents: tracker.sessionCostCents,
        dollars: tracker.sessionCostCents / 100,
      },
      daily: {
        cents: tracker.dailyCostCents,
        dollars: tracker.dailyCostCents / 100,
      },
    },
    limits: {
      request: {
        tokens: limits.maxTokensPerRequest,
        costCents: limits.maxCostPerRequestCents,
      },
      session: {
        tokens: limits.maxTokensPerSession,
        costCents: limits.maxCostPerSessionCents,
      },
      daily: {
        tokens: limits.maxTokensPerUserDaily,
        costCents: limits.maxCostPerUserDailyCents,
      },
    },
    percentUsed,
  };
