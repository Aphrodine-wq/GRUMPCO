 ...
 */
export function getBestProvider(): { provider: string; modelId: string } | null {
...
export const QUICK_START_TEMPLATES: QuickStartTemplate[] = [
  ...
  },
  {
    ...
    freeAgentCapabilities: ['file', 'git', 'bash', 'docker', 'cloud', 'monitoring'],
  },
  {
    id: 'mobile-backend',
  ...
  },
  {
    ...
    diagramStyle: 'comprehensive',
    freeAgentCapabilities: ['file', 'git', 'bash', 'docker', 'api_call', 'webhooks', 'heartbeats'],
  },
];
