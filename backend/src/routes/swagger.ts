...
\`\`\`
  ...
  tags: [
    ...
    { name: 'Ship', description: 'SHIP workflow (Spec, Hypothesis, Implement, Prove)' },
    ...
    schemas: {
      Error: {
        ...
        properties: {
          ...
          details: { type: 'string', description: 'Additional details (dev only)' },
        },
        required: ['error', 'code'],
      },
      Message: {
  ...
  paths: {
    ...
    '/api/chat/stream': {
      post: {
        ...
        description: 'Send messages and receive streaming AI responses with tool calling support.',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
    ...
    '/api/ship/start': {
      post: {
        ...
        description: 'Begin the Spec-Hypothesis-Implement-Prove workflow for a project.',
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  types: {
                    type: 'array',
                    items: { type: 'string', enum: ['doc', 'code', 'spec', 'grump'] },
                  },
