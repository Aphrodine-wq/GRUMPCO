...
const ROUTE_DEFINITIONS: RouteEntry[] = [
  ...
  { path: '/api/gagent', module: './gagent.js', priority: 'cold', skipServerless: true },
  ...
  { path: '/api/agent', module: './agent.js', priority: 'cold', skipServerless: true },
  { path: '/api/agents', module: './agents.js', priority: 'cold', skipServerless: true },
  { path: '/api/jobs', module: './jobs.js', priority: 'cold', skipServerless: true },
  { path: '/api/cron', module: './cron.js', priority: 'cold', skipServerless: true },

  // ── Collaboration & Workspace (WARM) ─────────────────────────────────────
  { path: '/api/collaboration', module: './collaboration.js', priority: 'warm' },
  ...
  { path: '/api/heartbeats', module: './heartbeats.js', priority: 'cold', skipServerless: true },

  // ── Infrastructure & DevOps (COLD - desktop only) ────────────────────────
  { path: '/api/cloud', module: './cloud.js', priority: 'cold' },
  { path: '/api/docker', module: './docker.js', priority: 'cold', skipServerless: true },
  { path: '/api/ollama', module: './ollama.js', priority: 'cold', skipServerless: true },
  ...
  { path: '/api/analyze', module: '../features/codebase-analysis/routes.js', priority: 'cold' },
  { path: '/api/security', module: '../features/security-compliance/routes.js', priority: 'cold' },
  { path: '/api/infra', module: '../features/infrastructure/routes.js', priority: 'cold' },
  { path: '/api/testing', module: '../features/testing-qa/routes.js', priority: 'cold' },
  { path: '/api/intent', module: '../features/intent-optimizer/routes.js', priority: 'cold' },
