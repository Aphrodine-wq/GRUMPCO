...
router.post('/push', async (req: Request, res: Response) => {
  try {
    ...
    const parsed = JSON.parse(data) as { emailAddress?: string; historyId?: string };
    logger.info({ email: parsed.emailAddress, historyId: parsed.historyId }, 'Gmail push received');
