 ...
 */
router.get('/apps/:appName', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/apps/:appName/logs', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { appName } = req.params;
 ...
 * Stop a deployed app
 */
router.post('/apps/:appName/stop', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { appName } = req.params;
 ...
 */
router.delete('/apps/:appName', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { appName } = req.params;
