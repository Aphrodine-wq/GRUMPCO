...
import { storeApiKey, storeBotToken, getApiKey, deleteSecret } from '../services/secretsService.js';
...
const providerSchema = z.enum([
  'discord', 'slack', 'spotify', 'imessage', 'signal', 'whatsapp',
  'gmail', 'google_calendar', 'telegram', 'notion', 'obsidian', 'twitter',
  'whoop', 'philips_hue', 'home_assistant', 'elevenlabs', 'twilio',
]);
...
/**
 * GET /integrations/audit-logs
 * Get integration-related audit logs
 */
