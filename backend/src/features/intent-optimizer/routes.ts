...
import { OptimizationMode, OptimizationRequest } from './types.js';
 ...
 */
router.post('/optimize', async (req: Request<Record<string, never>, object, OptimizeBody>, res: Response) => {
      ...
      modes: [
        {
          ...
          description: 'Optimize intent for code generation with focus on implementation details, code patterns, and specific libraries',
          bestFor: ['Generating production code', 'Creating test suites', 'Refactoring existing code'],
        },
        {
          id: 'architecture',
          name: 'Architecture Review',
          description: 'Optimize intent for architecture review with focus on high-level design, system structure, and scalability',
