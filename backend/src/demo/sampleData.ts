...
export const DEMO_ARCHITECTURE: SystemArchitecture = {
  ...
  projectDescription:
    "A simple todo app with user authentication and real-time sync.",
...
export const DEMO_PRD: PRD = {
  ...
  sections: {
    overview: {
      vision:
        "A minimal todo app to demonstrate G-Rump Architecture → Spec → Code.",
    ...
    features: [
      {
        ...
        priority: "must",
        userStories: [
          "As a user I want to add tasks so that I can track work.",
        ],
        acceptanceCriteria: [
