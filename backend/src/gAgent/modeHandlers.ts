...
export async function handleCodegenMode(
  ...
  if (result.success) {
    ...
    if (request.workspaceRoot) {
      const { generateProjectDocs } = await import('../services/ship/generateProjectDocs.js');
      ...
      const { runProjectTests } = await import('../services/ship/runProjectTests.js');
      ...
      const { runProjectBundleReport } = await import('../services/ship/runProjectBundleReport.js');
