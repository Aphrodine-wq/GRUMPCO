...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '2.1.0',
      description:
        'The AI Product Operating System - Transform natural language into production-ready code',
      contact: {
        name: 'G-Rump Team',
    ...
    servers: [
      {
        url:
          env.NODE_ENV === 'production' ? 'https://api.g-rump.com' : `http://localhost:${env.PORT}`,
          ...
          properties: {
            ...
            preferences: {
              ...
              properties: {
                ...
                deploymentTarget: {
                  type: 'string',
                  enum: ['docker', 'vercel', 'netlify', 'aws', 'gcp'],
                },
              },
            },
          },
