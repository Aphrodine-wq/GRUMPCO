...
export const generateDbSchemaTool: Tool = {
  ...
  input_schema: {
    type: 'object',
    properties: {
      description: { type: 'string', description: 'Architecture/PRD description' },
      targetDb: { type: 'string', enum: ['sqlite', 'postgres', 'mysql'], description: 'Target DB' },
      format: { type: 'string', enum: ['sql', 'drizzle'], description: 'Output format' },
    },
...
export const generateMigrationsTool: Tool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      targetDb: { type: 'string', enum: ['sqlite', 'postgres'], description: 'Target DB' },
    },
    required: ['schemaDdl'],
  },
};
