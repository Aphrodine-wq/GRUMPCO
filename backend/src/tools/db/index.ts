...
export const generateDbSchemaTool: Tool = {
  ...
  description:
    "Generate database schema from architecture description. Use for user DB creation.",
  input_schema: {
    type: "object",
    properties: {
      description: {
...
export type GenerateMigrationsInput = z.infer<
  typeof generateMigrationsInputSchema
>;

export const generateMigrationsTool: Tool = {
  name: "generate_migrations",
  description:
    "Generate migration files from schema DDL. Output is for user to review and apply.",
  input_schema: {
    type: "object",
    properties: {
