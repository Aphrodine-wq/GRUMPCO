<script lang="ts">
  ...
  let { phase, canProceedToPrd, canProceedToCodegen, canDownload, isStreaming }: Props = $props();
  ...
  const showActions = $derived(
    !isStreaming && (canProceedToPrd || canProceedToCodegen || canDownload || phase !== 'idle')
  );
...
{#if showActions}
  <div class="workflow-actions">
    <div class="actions-container">
      {#if canProceedToPrd}
        <button onclick={() => dispatch('proceed-prd')} class="action-btn primary">
          <svg
      ...
      {#if canProceedToCodegen}
        <button onclick={() => dispatch('proceed-codegen')} class="action-btn primary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      {#if canDownload}
        ...
        >
          <svg
            ...
            ></polyline><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"
            ></path></svg
          >
          Cursor
        </button>
      ...
      {#if canRefine}
        <button onclick={() => dispatch('refine')} class="action-btn secondary">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      {#if canReset}
        <button onclick={() => dispatch('reset')} class="action-btn subtle">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
