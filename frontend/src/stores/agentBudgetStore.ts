...
interface agentBudgetStoreState {
  // Budget status
...
const initialState: agentBudgetStoreState = {
  status: null,
  config: null,
  sessionCost: 0,
  dailyCost: 0,
...
const store = writable<agentBudgetStoreState>(initialState);
...
export const agentBudgetStore = {
   ...
   * Get current state
   */
  getState(): agentBudgetStoreState {
    return get(store);
  },
...
export default agentBudgetStore;
