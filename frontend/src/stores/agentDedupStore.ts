...
interface agentDedupStoreState {
  // Library stats
...
const initialState: agentDedupStoreState = {
  stats: null,
  patterns: [],
...
const store = writable<agentDedupStoreState>(initialState);
...
export default agentDedupStore;
