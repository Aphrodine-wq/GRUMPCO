    ...
    steps: [
      {
        ...
        content: 'Start by typing your project idea here. Try "Build a todo app with React and Node.js"',
        position: 'top',
      },
      {
        target: '[data-mode-selector]',
        title: 'Choose Your Mode',
        content: 'Switch between Design (architecture diagrams) and Code (interactive development) modes.',
        position: 'bottom',
      },
      {
    ...
    steps: [
      {
        ...
        title: 'Set Workspace',
        content: 'Choose your project directory. All file operations will be scoped to this folder.',
        position: 'bottom',
      },
      {
      ...
      },
      {
        ...
        content: 'Watch the AI use tools like bash, file_read, and file_write to build your project.',
        position: 'left',
      },
    ],
  },
...
export const QUICK_START_TEMPLATES: QuickStartTemplate[] = [
  {
    ...
    icon: '✅',
    prompt: 'Build a todo app with React frontend, Node.js/Express backend, and PostgreSQL database. Include user authentication, task CRUD operations, and due date reminders.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '🔌',
    prompt: 'Create a RESTful API with Node.js and Express. Include JWT authentication, user management, rate limiting, and PostgreSQL database with migrations.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '🎨',
    prompt: 'Build a design system with React components, TypeScript, Tailwind CSS, and Storybook. Include buttons, forms, cards, modals, and documentation.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '🏗️',
    prompt: 'Design a microservices architecture with API gateway, authentication service, user service, and product service. Include service discovery, load balancing, and inter-service communication.',
    mode: 'design',
  ...
  },
  {
    ...
    icon: '🛒',
    prompt: 'Build an e-commerce platform with product catalog, shopping cart, checkout with Stripe, order management, and admin dashboard. Use Next.js, Node.js, and PostgreSQL.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '💬',
    prompt: 'Create a real-time chat application with WebSocket support, user presence, typing indicators, message history, and file sharing. Use React, Socket.io, and MongoDB.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '📊',
    prompt: 'Build an analytics dashboard with charts, graphs, real-time data updates, and export functionality. Use React, D3.js, and a REST API backend.',
    mode: 'ship',
  ...
  },
  {
    ...
    icon: '📱',
    prompt: 'Create a backend API for mobile apps with push notifications, file uploads, offline sync, and real-time updates. Use Node.js, MongoDB, and Firebase.',
    mode: 'ship',
